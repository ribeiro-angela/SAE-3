    ...
    <div class="admin-container">
        ...
        <div class="admin-content">
            <div class="content-header">
                ...
                <a href="/admin/missions_add.php" class="btn-primary">
            ...
            <div class="stats-mini">
                <div class="stat-mini">
                    <span class="stat-mini-label">Total missions</span>
                    <span class="stat-mini-value"><?php echo $stats['total']; ?></span>
                </div>
                <div class="stat-mini">
                    <span class="stat-mini-label">À venir</span>
                    <span class="stat-mini-value"><?php echo $stats['a_venir']; ?></span>
                </div>
                <div class="stat-mini">
                    <span class="stat-mini-label">En cours</span>
                    <span class="stat-mini-value"><?php echo $stats['en_cours']; ?></span>
                </div>
                <div class="stat-mini">
                    <span class="stat-mini-label">Planifiées</span>
                    <span class="stat-mini-value"><?php echo $stats['planifiees']; ?></span>
                </div>
            </div>
