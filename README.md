# Projet SAE‑3 : Refonte du site de l’Armée du Salut

## 1. Contexte du projet
Projet dans le cadre de la **SAE S3-01 (Mission 1 – FRONT)**.  
Demande **a cadre pedagogique** de France Bénévolat : refonte du site d’une association membre. 

## 2. Choix de l'association
...
- usage d’un framework (Bootstrap/Bulma) ? 

### Objectifs fonctionnels
- Améliorer l’ergonomie et la hiérarchie visuelle 
- Clarifier les actions principales (don, bénévolat, contact).  
- Réduire l’impact écologique  
- Respecter les critères d’accessibilité (contraste, taille de police, lisibilité).  
