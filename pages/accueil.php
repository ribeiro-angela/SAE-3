...
<main>
    ...
    <section class="slogan-section">
        <div class="section-content">
            <div class="slogan-details">
                <h1 class="title">Soupe,<br>Savon, Salut</h1>
                <h3 class="subtitle">Ensemble, nous offrons espoir et soutien à ceux qui en ont besoin</h3>
                <div class="button_accueil">
                    <a href="#" class="button_accueil contact-us">Nous Contacter</a>
                    <a href="#" class="button_accueil don">Je fais un Don</a>
                </div>
            </div>
